...
| :--- | :--- | :--- |
| **ROC-AUC** | **0.999** | 5-fold CV, XGBoost Regressor |
| **학습 데이터** | **534건** | 수질 검사 기록 총량 |
| **오염 발생 빈도** | **6건** | 대장균/장구균 기준치 초과 사례 |
...
> [!WARNING]
> ### 🟡 1단계: 주의 알림 (기준 점수: 5.152)
> * **목적**: 관리자에게 선제적 경고 알림 발송
> * **재현율 (Recall)**: **100.0%** (오염 사태 6/6건 선제 탐지)
> * **오탐 (False Positive)**: 4건

> [!CAUTION]
> ### 🔴 2단계: 입수 통제 (기준 점수: 6.363)
> * **목적**: 해수욕장 입수 전면 통제 및 안내 방송
> * **재현율 (Recall)**: **83.3%** (치명적 오염 사태 5/6건 탐지)
