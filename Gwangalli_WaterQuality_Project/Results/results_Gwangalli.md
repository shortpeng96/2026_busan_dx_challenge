...
| :--- | :--- | :--- |
| **ROC-AUC** | **0.944** | 5-fold CV, XGBoost Regressor |
...
> [!WARNING]
> ### 🟡 1단계: 주의 알림 (기준 점수: 0.306)
> * **목적**: 관리자에게 선제적 경고 알림 발송
> * **재현율 (Recall)**: **95.7%** (오염 사태 45/47건 선제 탐지)
> * **오탐 (False Positive)**: 70건

> [!CAUTION]
> ### 🔴 2단계: 입수 통제 (기준 점수: 1.384)
> * **목적**: 해수욕장 입수 전면 통제 및 안내 방송
> * **재현율 (Recall)**: **55.3%** (치명적 오염 사태 26/47건 탐지)
> * **오탐 (False Positive)**: 4건 (과잉 통제 최소화)
