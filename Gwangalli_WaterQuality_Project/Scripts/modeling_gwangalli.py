...
beach_name = "Gwangalli"
base_dir = "C:\\Sandbox\\2026_busan_dx_challenge"
proj_dir = os.path.join(base_dir, "Gwangalli_WaterQuality_Project")

print("1. Loading Spatial Dataset...")
df_master = pd.read_csv(os.path.join(proj_dir, "Data_Processed\\master_dataset_gwangalli.csv"))
...
best_feats = ['suyeong_vol_1d_lag', 'nambu_vol_1d_lag', 'CSO_Flag_East']
