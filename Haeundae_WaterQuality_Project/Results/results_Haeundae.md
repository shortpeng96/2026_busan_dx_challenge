...
| :--- | :--- | :--- |
| **ROC-AUC** | **0.942** | 5-fold CV, XGBoost Regressor |
...
> [!WARNING]
> ### 🟡 1단계: 주의 알림 (기준 점수: 0.583)
> * **목적**: 관리자에게 선제적 경고 알림 발송
> * **재현율 (Recall)**: **61.5%** (오염 사태 8/13건 선제 탐지)
> * **오탐 (False Positive)**: 2건

> [!CAUTION]
> ### 🔴 2단계: 입수 통제 (기준 점수: 1.190)
> * **목적**: 해수욕장 입수 전면 통제 및 안내 방송
> * **재현율 (Recall)**: **46.2%** (치명적 오염 사태 6/13건 탐지)
