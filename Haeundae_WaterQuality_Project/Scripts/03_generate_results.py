...
category_map = {
    ...
    '하수처리 요인': ['suyeong_vol', 'suyeong_vol_1d_lag', 'suyeong_cap', 'CSO_Flag_Suyeong'],
    '조위·지리 요인': ['tide_max', 'tide_min', 'tide_range', 'tide_range_1d_lag', 'distance_from_estuary_km'],
}
cat_importances = {'기상 요인': 0, '해양부이 요인': 0, '하수처리 요인': 0, '조위·지리 요인': 0}
