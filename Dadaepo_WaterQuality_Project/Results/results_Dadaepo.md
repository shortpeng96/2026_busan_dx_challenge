...
> [!TIP]
> **Executive Summary**
> 본 보고서는 다대포 해수욕장의 수질 오염(대장균/장구균 초과)을 예측하기 위한 AI 모델의 최종 성능 및 운영 기준을 요약한 기업용 엔터프라이즈 리포트입니다.
...
| **학습 데이터** | **305건** | 수질 검사 기록 총량 |
| **오염 발생 빈도** | **46건** | 대장균/장구균 기준치 초과 사례 |
...
> [!WARNING]
> ### 🟡 1단계: 주의 알림 (기준 점수: 0.308)
> * **목적**: 관리자에게 선제적 경고 알림 발송
> * **재현율 (Recall)**: **89.1%** (오염 사태 41/46건 선제 탐지)
> * **오탐 (False Positive)**: 42건

> [!CAUTION]
> ### 🔴 2단계: 입수 통제 (기준 점수: 1.499)
> * **목적**: 해수욕장 입수 전면 통제 및 안내 방송
> * **재현율 (Recall)**: **50.0%** (치명적 오염 사태 23/46건 탐지)
