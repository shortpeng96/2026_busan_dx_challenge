...
proj_dir = os.path.join(base_dir, "Dadaepo_WaterQuality_Project")

print("1. Loading Spatial Dataset...")
df_master = pd.read_csv(os.path.join(proj_dir, "Data_Processed\\master_dataset_v2.csv"))
...
best_feats = ['sewage_discharge_1d_lag', 'temp_1d_lag', 'discharge_1d_lag', 'precip_1d_lag']
